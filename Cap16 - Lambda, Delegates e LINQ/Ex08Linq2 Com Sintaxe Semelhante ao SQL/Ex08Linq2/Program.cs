...
namespace Ex08
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Print foi uma função criada apenas para imprimir
            ...
            //Seleciona o que tem categoria de tier 1
            ...
            //Pula os dois primeiros elementos de r4 e pega os 4 seguintes     
            ...
            //var r9 = products.Where(p => p.Id == 33).SingleOrDefault();
            var r9 = (from p in products where p.Id == 33 select p).SingleOrDefault();
            Console.WriteLine("Single or default test 2: " + r9);
            Console.WriteLine();

            //DAQUI PRA BAIXO SÃO OPERAÇÕES DE AGREGAÇÃO
            //NÃO APLIQUEI A SINTAXE ALTERNATIVA POR JÁ POSSUIR EXEMPLOS SUFICIENTES ACIMA
            //EXCETO NO R16  LÁ EMBAIXO ONDE USEI O GROUPBY
            ...
            //Média (mas se a busca for vazia dá exceção ao tentar calcular a média)
            var r13 = products
                .Where(p => p.Category.Id == 1)
                .Average(p => p.Price);
            Console.WriteLine("Category 1, Average prices: " + r13);

            //Média (Sem dar exceção caso esteja vazio, pois retornará zero se vazio)
            var r14 = products
            ...
            //Soma dos precos dos produtos da categoria 1
            //0.0 é um valor inicial definido na agregação para proteger
            //de exceção em caso de lista vazia
            var r15 = products
                .Where(p => p.Category.Id == 1)
                .Select(p => p.Price)
            ...
            //Agrupar produtos por categoria e imprimir
